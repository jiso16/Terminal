...
void CdCheck()
{
  ...
  ```
1. 사용하려는 전역변수가 main함수가 있는 소스파일에서 선언 됐기 때문에 extern을 이용하여 선언해주 
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MzY0MTI3MCwyMDg4ODUxMjI1LDE3ND
c2MjI1NywtMTAzNzI0ODU5MiwtMTM4MzQzMTA1LDE3ODI3NjYw
MiwzODUwMjA2NDVdfQ==
-->