...
```
 ...
 -ls를 입력하면 현재 디렉토리를 확인해서 파일명과 폴더명을 출력합니다.
...
2. cd 명령어
- while문 안에 있는 command로 이용하고자 하는 명령어를 입력받습니다.
- 만약 cd 명령어가 입력되었다면 CdCheck 함수를 호출합니다.
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1ODYxMDQ5ODUsMTc0NzYyMjU3LC0xMD
M3MjQ4NTkyLC0xMzgzNDMxMDUsMTc4Mjc2NjAyLDM4NTAyMDY0
NV19
-->