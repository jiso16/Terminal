...
2.  일단 main.c 파일의 main함수에서 command를 이용하여 사용할 명령어를 입력 받습니다. 이때 command가 cd라면 CdCheck함수를 호출해 path를 입력받고 두가지의 경우로 나눕니다.
  - path가 "이동하려는 폴더명" 일 때
   ...
   -path가 현재 디렉토리에 있는 홀더명이 아니라면 경로를 이동하지 않습니다.
![StartCd](https://user-images.githubusercontent.com/66424045/90889506-473d9e00-e3f3-11ea-86b1-5ec4e29ded84.PNG)
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc5OTY2MTQ3LDIwODg4NTEyMjUsMTc0Nz
YyMjU3LC0xMDM3MjQ4NTkyLC0xMzgzNDMxMDUsMTc4Mjc2NjAy
LDM4NTAyMDY0NV19
-->